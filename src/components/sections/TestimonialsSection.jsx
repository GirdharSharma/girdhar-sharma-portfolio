...
export default function TestimonialsSection() {
    ...
    return (
        ...
        >
            {/* Label */}
            <div className="tes-animate sect-label">
            ...
            <div className="tes-animate">
                {/* Quote mark */}
                <div className="mb-4 text-[28px] leading-none text-[var(--accent)]">
                    "
                </div>
                ...
                <div className="mt-6 flex items-center gap-2">
                    ...
                    <button
                        onClick={prev}
                        disabled={current === 0}
                        className={`flex h-[34px] w-[34px] items-center justify-center rounded-[9px] bg-[var(--bg-card-border)] text-[var(--text-secondary)] transition-colors ${current === 0
                    ...
                    <button
                        ...
                        className={`flex h-[34px] w-[34px] items-center justify-center rounded-[9px] bg-[var(--bg-card-border)] text-[var(--text-secondary)] transition-colors ${current === TESTIMONIALS.length - 1
                            ? 'cursor-not-allowed opacity-35'
                            : 'hover:bg-[var(--accent-dim)] hover:text-[var(--accent)]'
                            }`}
                    >
